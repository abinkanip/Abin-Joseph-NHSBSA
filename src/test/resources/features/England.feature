Feature: As cicitzen of the UK
  ...
  @test1
  Scenario: England user can visit tool and provide circumstances into the tool-happy flow- married
    ...
    @test1
    Scenario: England user can visit tool and provide circumstances into the tool-Unmarried-selcting 'No' most of the questions
    ...
    When I Select 'No' radio-button
    And I click the 'Next' button
    Then I should be on the 'Do you have diabetes?' page
    When I Select 'No' radio-button
    And I click the 'Next' button
    Then I should be on the "To check what help you can get with NHS charges, we need to know if you're affected by any of these conditions" page
    When I Select 'No' radio-button
    And I click the 'Next' button
    Then I should be on the 'Do you have glaucoma?' page
    When I Select 'No' radio-button
    And I click the 'Next' button
    ...
    When I Select 'No' radio-button
    And I click the 'Next' button
    Then I should get results of 'You could get help to pay for your NHS costs'
    
    @test1
    Scenario: England user can visit tool and provide circumstances into the tool-Not married and diabetes
    ...
    When I Select 'Yes' radio-button
    And I click the 'Next' button
    Then I should be on the 'Medication to control your diabetes?' page
    When I Select 'Yes' radio-button
    And I click the 'Next' button
    Then I should be on the 'Do you live permanently in a care home?' page
    When I Select 'No' radio-button
    ...
    @test1
    Scenario: England user can visit tool and provide circumstances into the tool-Unmarried and getting Income support
