Feature: As cicitzen of the UK
  ...
  @test3
  Scenario: Wales user can visit tool and provide circumstances into the tool-happy flow-Married
    ...
    Then I should get a result of 'You get free' items and 'You get money off' items
     ...
     @test3
    Scenario: Wales user can visit tool and provide circumstances into the tool-Unmarried-selcting 'No' most of the questions
    ...
    Then I should get results of 'You get free'
     ...
     @test3
    Scenario: Wales user can visit tool and provide circumstances into the tool-unmarried and diabetes
    ...
    Then I should get results of 'You get free'
     ...
     @test3
    Scenario: Wales user can visit tool and provide circumstances into the tool-Unmarried and getting Income support
